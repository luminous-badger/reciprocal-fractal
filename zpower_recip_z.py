...
# REcip for higher powers of Z.
# JM Sat 17 Nov 2018 13:27:03 GMT
...
MsgText = 'Brot for Z^' + str( ZPower ) + '+' +  str( Znumerator ) + '/Z'
fname = 'Recip_Brot_Z' + str( ZPower ) + '_' + str( Znumerator ) + '.png'
